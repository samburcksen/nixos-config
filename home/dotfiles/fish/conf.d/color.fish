# This file sets the colors of user-written text and the pager.
# The pager is openend by pressing the autocomplete key
# while there is more than one option available.
# See https://fishshell.com/docs/current/interactive.html.
# Prompt colors are set in the oh-my-fish configuration.
